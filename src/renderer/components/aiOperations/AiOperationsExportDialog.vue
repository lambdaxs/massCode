...
<template>
  <Dialog.Dialog v-model:open="open">
    ...
    >
      <Dialog.DialogHeader>
        <Dialog.DialogTitle>
          {{ title ?? i18n.t("spaces.aiOperations.export.title") }}
        </Dialog.DialogTitle>
        <Dialog.DialogDescription>
          {{ description ?? i18n.t("spaces.aiOperations.export.description") }}
        </Dialog.DialogDescription>
      </Dialog.DialogHeader>
      ...
      <div class="scrollbar min-h-0 overflow-y-auto">
        ...
        >
          ...
          {{ i18n.t("spaces.aiOperations.export.loadingFolders") }}
        </div>
      ...
      <Dialog.DialogFooter>
        ...
        <Button
          ...
          @click="onConfirm"
        >
          {{ i18n.t("spaces.aiOperations.export.confirm") }}
        </Button>
      </Dialog.DialogFooter>
    </Dialog.DialogContent>
  </Dialog.Dialog>
